function start() { // Inicio da função start()
	...
	$("#fundo-game").append("<div id='amigo' class='anima2'></div>");
...
jogo.timer = setInterval(loop,40);
...
function gameOver() {
	...
	$("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><p>Jogar Novamente</p></div>");
